...
open class FlippersExampleScene: SKScene, SKPhysicsContactDelegate {
    ...
    open override func didMove(to view: SKView) {
        ...
        // Flipper Left
        flipperLeft = Flipper(anchorPosition: CGPoint(x: -104.25, y: -100), name: "FlipperL", zRotation: -30, restitution: flipperRestitution, friction: flipperFriction, categoryBitMask: flipperCategory, side: "L")
        ...
        // Flipper Right
        flipperRight = Flipper(anchorPosition: CGPoint(x: 104.25, y: -100), name: "FlipperR", zRotation: 210, restitution: flipperRestitution, friction: flipperFriction, categoryBitMask: flipperCategory, side: "R")
