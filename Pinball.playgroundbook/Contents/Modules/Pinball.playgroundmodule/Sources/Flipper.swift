...
open class Flipper: SKSpriteNode {
    ...
    var force: CGFloat = 1750
    
    init(anchorPosition: CGPoint, name: String, zRotation: CGFloat, restitution: CGFloat, friction: CGFloat, categoryBitMask: UInt32, side: String) {
    ...
    open func lower() {
        ...
        let flip = SKAction.rotate(toAngle: degreesToRadians(lowerAngle!), duration: 0.05)
